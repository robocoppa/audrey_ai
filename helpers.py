...
_CODE_REVIEW_BASE = (
    ...
    "Prefer a short, high-confidence report over a long checklist. Keep only the "
    "strongest findings and avoid speculative padding.\n\n"
    ...
    "- Critical: deterministic crash, data corruption/loss, or concrete exploitable "
    "security flaw with an explicit attack path.\n"
    "- High: likely user-visible incorrect behavior in normal use.\n"
    "- Otherwise demote to low-priority or open questions.\n\n"
